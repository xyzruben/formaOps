    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            {prompt.description ||
              'Configure variables and execute this prompt'}
          </CardDescription>
        </CardHeader>
        <CardContent>
              ...
              <div className="grid gap-4 sm:grid-cols-3">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={e =>
                      setValue('maxTokens', parseInt(e.target.value) || 2000)
                    }
                  />
                  {errors.maxTokens && (
                    <p className="text-xs text-destructive">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={e =>
                      setValue('temperature', parseFloat(e.target.value) || 0.7)
                    }
                  />
                  {errors.temperature && (
                    <p className="text-xs text-destructive">
        ...
        <Card className="border-destructive">
          ...
          <CardContent className="space-y-4">
            ...
            {error.code === 'VALIDATION_ERROR' && (
              <p className="text-sm text-muted-foreground">
                Please check your inputs and try again. Validation errors cannot
                be retried.
              </p>
            )}
      ...
      {executionResult && (
        <Card>
          ...
          <CardContent className="space-y-4">
              ...
              <div className="space-y-1">
                ...
                <div className="text-sm font-medium">
                  ...
                  <span className="text-muted-foreground ml-1">
                    ({executionResult.tokenUsage.inputTokens}+
                    {executionResult.tokenUsage.outputTokens})
                  </span>
                </div>
              </div>
              <div className="space-y-1">
                ...
                <Badge
                  variant={
                    executionResult.validationStatus === 'PASSED'
                      ? 'default'
                      : executionResult.validationStatus === 'FAILED'
                        ? 'destructive'
                        : 'secondary'
                  }
                >
            ...
            {/* Validation Errors */}
            {executionResult.validationErrors &&
